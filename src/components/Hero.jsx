...
function Hero({ isDark }) {
  ...
  return (
    <header className="bg-white dark:bg-[#121212] transition-colors duration-300 md:py-4">
      <div className="mt-16 w-full place-items-stretch">
        <div className="container mx-auto text-center">
          <Typography className="inline-flex text-xs rounded-lg border-[1.5px] border-blue-gray-50 bg-white dark:bg-gray-900 py-1 lg:px-4 px-1 font-medium text-primary">
            Hi there, Welcome!
          </Typography>
          <Typography
            variant="h1"
            className="mx-auto my-6 w-full leading-snug text-blue-gray-900 dark:text-[#FFFFFF] !text-2xl lg:max-w-3xl lg:!text-5xl"
          >
            Discover{" "}
          ...
          <div className="mt-8 grid w-full place-items-start md:justify-center">
            ...
            >
              ...
              <Button
                type="submit"
                className="w-full px-4 md:w-[12rem] bg-gray-900 dark:bg-green-500"
              >
                Find Recipe!
              </Button>
            </form>
